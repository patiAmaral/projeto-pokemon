...
const imagemBotaoTrocaDTema = document.querySelector(".imagem-botao");

// passo 3 - dar um jeito de identificar o clique do usuário no botão de troca de tema

//addEventListener serve para "espionar" o usuario, quando o usuario clicar no botao, o codigo enrtre {} sera executado
botaoAlterarTema.addEventListener("click", () => {
    ...
    const modoEscuroAtivado = body.classList.contains("modo-escuro");
     //conatains mostra true ou false

     body.classList.toggle("modo-escuro"); 
     //substitui o add e remove do if else
    if (modoEscuroAtivado) {
        ////passo 7 - remover a classe do modo-escuro do body
        //body.classList.remove("modo-escuro");

        //passo 8 - trocar a imagem do botão de alterar tema pra sol
        imagemBotaoTrocaDTema.setAttribute("src", "./src/imagens/imagens/sun.png");
    ...
    imagemBotaoTrocaDTema.setAttribute("src", "./src/imagens/imagens/moon.png");
    }
});
